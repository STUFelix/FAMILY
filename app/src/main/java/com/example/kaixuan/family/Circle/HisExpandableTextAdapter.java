...
public abstract class HisExpandableTextAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T> {
    ...
    public HisExpandableTextAdapter() {
        super();
    ...
    public void onBindViewHolder(final T holder, final int position) {
        ...
        if(state == null){
            ...
            contentTV.setText(HisUtil.getContent(position));
        }else{
