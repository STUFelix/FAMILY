...
public class HisTestListAdapter extends HisExpandableTextAdapter<HisTestListAdapter.TestHolder> {

    private Context mContext;

    public HisTestListAdapter(Context context) {
        mContext = context;
    }

    @Override
    public TestHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new TestHolder(LayoutInflater.from(mContext).inflate(R.layout.his_item_test_list, parent, false));
    }
    ...
    public void onBindViewHolder(final TestHolder holder, final int position) {
        ...
        holder.name.setText(HisUtil.getName(position));
